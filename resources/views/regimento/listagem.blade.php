...
@section('content')
    ...
    <div class="col-md-12">
        <div class="d-flex justify-content-end">
            <a href="{{ route('regimento.cadastro') }}" class="btn btn-secondary btn-sm ms-auto">Cadastrar <i
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Listagem de Regimentos Internos</h4>
            </div>
            <div class="card-body">
